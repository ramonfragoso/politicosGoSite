...
var Wrapper = _styledComponents2.default.g(_templateObject, function (props) {
...
var Grid = function Grid(_ref) {
  ...
  if (gridVisible) {
    ...
    for (var i = minX; i <= maxX + unitWidth; i++) {
      gridX.push(_react2.default.createElement("line", {
        key: i,
        x1: getX(i),
        y1: getY(minY),
        x2: getX(i),
    ...
    for (var _i = minY; _i <= maxY; _i += Math.floor(maxY / yStep)) {
      gridY.push(_react2.default.createElement("line", {
        key: _i,
        x1: getX(minX),
        y1: getY(_i),
