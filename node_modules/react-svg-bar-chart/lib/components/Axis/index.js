...
var SvgGroup = _styledComponents2.default.g(_templateObject, function (props) {
  return props.color;
}, function (props) {
  return props.width;
}, function (props) {
...
var Axis = function Axis(_ref) {
  ...
  return axisVisible ? _react2.default.createElement(
    SvgGroup,
    ...
    _react2.default.createElement("line", { x1: getX(minX), y1: getY(minY), x2: getX(minX), y2: getY(maxY) })
  ) : null;
};

Axis.propTypes = process.env.NODE_ENV !== "production" ? {
